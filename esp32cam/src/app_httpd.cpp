...
void setupLedFlash() {
    // 1. Configure the LEDC channel (Frequency = 5000 Hz, Resolution = 8 bits)
    ledcSetup(LEDC_CHANNEL, 5000, 8); 

    // 2. Attach the GPIO pin to the configured channel
    // LED_GPIO_NUM is usually defined as GPIO 4 for the AI-Thinker board
